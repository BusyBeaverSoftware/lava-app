<!-- lava:map hash=b351b28528e3e411 -->
# AGENTS.md
...
|---|----|-----|--------|
| app.dir | value | - | core:src/Boot/Steps/RegisterCoreServices.php:43 |
| app.env | value | - | core:src/Boot/Steps/RegisterCoreServices.php:44 |
| Lava\Core\Features\Features | factory | Lava\Core\Features\Features | core:src/Boot/Steps/RegisterCoreServices.php:51 |
| Lava\Core\Features\FeatureScope | singleton | Lava\Core\Features\FeatureScope | core:src/Boot/Steps/RegisterCoreServices.php:56 |
| Lava\Core\Log\LineLogger | singleton | Lava\Core\Log\LineLogger | core:src/Boot/Steps/RegisterCoreServices.php:68 |
| App\Greeter | singleton | App\Greeter | app/Services.php:20 |
| Psr\Log\LoggerInterface | alias | Lava\Core\Log\LineLogger | core:src/Boot/Steps/RegisterCoreServices.php:68 |
...
fatal. Two standard ids are filled by core only if nothing registered them
first — `Psr\Log\LoggerInterface` (a stderr LineLogger) and
`Psr\Clock\ClockInterface` (the system clock) — so an app that wants its own
simply registers the id here. This is also where an app declares the
